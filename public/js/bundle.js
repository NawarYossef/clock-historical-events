...
},{"./events.js":2,"./toggle.js":4}],4:[function(require,module,exports){
/* global $ */
/*global Events*/
"use strict"
...
let toggleData = {
                ...
                $(document).ready(function(){
                  ...
                  if (imgTitle === "texture") {
                    $("#hours, #minutes, #am-pm, #seconds, #month-date, #day-of-week, #month, #day-of-month").css({"color": "#190f0b", "font-family": "Cambria"})
                      ...
                      $("#hours, #minutes, #am-pm, #seconds, #month-date, #day-of-week, #month, #day-of-month").css({"color": "#694a0b", "font-family": "Microsoft YaHei"})
                  } else if (imgTitle === "shore") {
                      $("#hours, #minutes, #am-pm, #seconds, #month-date, #day-of-week, #month, #day-of-month").css({"color": "#404367", "font-family": "Trebuchet MS" })
  ...
  eventsToggle: function() {
    let that = this;
    $(document).ready(function(){
      $(".events-button").prop('checked') ?  $(".events").show("fast") : $(".events").hide("fast");
    });
  },
